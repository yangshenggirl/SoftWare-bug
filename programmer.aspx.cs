...
public partial class programmer : System.Web.UI.Page
{
    ...
    {
        string programmer = Request.QueryString["name"];
        Label3.Text = "欢迎，" + programmer;
        ...
        {
            if (xmlNode["dealPerson"].InnerText == programmer)
            {
    ...
    {
        Response.Redirect("updateBugState.aspx?id=" + GridView1.DataKeys[e.RowIndex]["id"].ToString());
    }
